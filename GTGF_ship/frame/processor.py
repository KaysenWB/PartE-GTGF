...
from frame.utils import Metrics
from model.GTGF import GTGF, LSTM
from data.dataloader import Dataset_ship
...
class processor(object):
    def __init__(self, args):
        ...
        model_dict = {'GTGF': GTGF, 'LSTM': LSTM}
    ...
    def train_epoch(self, epoch):
        ...
        for b_id, batch in enumerate(train_loader):
            ...
            _, loss_dict = self.net.forward(inputs,iftrain=True)
    ...
    def test_epoch(self):
        ...
        for b_id, batch in enumerate(test_loader):
            ...
            tar_y = inputs[0][self.args.obs_length:, :, :2].permute(1, 0, 2).detach().cpu().numpy()
